...
function buttonRefresh() {
    ...
    document.querySelector("button").addEventListener("click", function() {
        ...
        let newRandomImages = new Array ("./images/dice1.png","./images/dice2.png","./images/dice3.png","./images/dice4.png","./images/dice5.png","./images/dice6.png");
        ...
        let newRandomNumber = Math.floor((newRandomImages.length-1)*Math.random());
        
        // takes rand img and rand num and outputs a dice img
        document.getElementsByClassName("img1")[0].setAttribute("src",randomImages[randomNumber]);
        document.getElementsByClassName("img2")[0].setAttribute("src",newRandomImages[newRandomNumber]);
